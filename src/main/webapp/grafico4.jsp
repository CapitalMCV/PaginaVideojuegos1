    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="card-body">
                            <form action="">
                                ...
                                <table class="table table-bordered">
                                    <tr><th>Año<th>Total Vendido
                                            <%                                                for (VentaAnual x : obj.lisvenan()) {
                                                    out.print("<tr><td>" + x.getAno() + "<td>" + x.getCan_tot());
                                                }
                                            %>
                                </table>
                            </form>
                ...
                <div class="col-sm-8">
                    <div class="container">
                        <h2>Ventas Totales del Anuales</h2>
                        <div>
        ...
        <%
            String label = "", data = "";
            for (VentaAnual x : obj.lisvenan()) {
                label = label + "'" + x.getAno() + "',";
                data = data + x.getCan_tot() + ",";
            }
